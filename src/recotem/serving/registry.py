...
#: also a published contract: ``https://recotem.org/2.1/docs/operations.html`` tells operators the value
...
class ModelEntry:
    ...
    skipped:
        ...
        :meth:`ModelRegistry.health_counts`.  ``https://recotem.org/2.1/docs/operations.html``
