...
[First install: seed an artifact before serve starts](https://recotem.org/2.2/docs/deployment/kubernetes.html#first-install-seed-an-artifact-before-serve-starts)
...
- [ ] Read [Operations](https://recotem.org/2.2/docs/operations.html) for the signing-key
