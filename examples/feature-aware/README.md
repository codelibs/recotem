...
[recipe-reference.md](https://recotem.org/2.1/docs/recipe-reference.html#features)). `n_items:
...
- Case C cold-start (`:recommend-related` + `item_features` for an unseen
  seed item) — see
  [api-reference.md#feature-aware-cold-start](https://recotem.org/2.1/docs/serving-api.html#feature-aware-cold-start)
