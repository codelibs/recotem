...
# Documented in https://recotem.org/2.2/docs/serving-api.html. Bounds total candidate work per HTTP
...
# ``:batch-recommend-related`` call. Documented in https://recotem.org/2.2/docs/serving-api.html and
...
class RecommendRequest(BaseModel):
    ...
    # ``https://recotem.org/2.2/docs/serving-api.html#feature-aware-cold-start`` ("A known `user_id`
