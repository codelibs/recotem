...
- [docs2/quickstart.md](docs2/quickstart.md) — 5-minute walkthrough
- [docs2/recipe-reference.md](docs2/recipe-reference.md) — every field documented
- [docs2/operations.md](docs2/operations.md) — key rotation, sizing, troubleshooting
- [docs2/security.md](docs2/security.md) — threat model, IAM scopes, secrets handling
- [docs2/README.md](docs2/README.md) — full docs index
