...
Design:
  ...
  allow-list; that is a separate concern documented in https://recotem.org/2.2/docs/operations.html.
"""
...
def _make_client_with_metrics(
    ...
    monkeypatch.setattr(_m, "_V1_FEATURE_UNKNOWN_VALUE", None)
    monkeypatch.setattr(_m, "_V1_COLD_START_REQUESTS", None)
