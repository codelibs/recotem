...
def test_validate_reports_where_for_exception_whose_str_ignores_args(
    ...
    ``__init__`` (a plausible pattern per ``https://recotem.org/2.1/docs/plugin-authoring.html`` --
...
def test_inspect_corrupt_header_json_exits_5(tmp_path: Path, monkeypatch) -> None:
    ...
    _EXIT_ARTIFACT (5) explicitly, which matches what https://recotem.org/2.1/docs/operations.html documents.
    """
    from unittest.mock import patch
