...
# or control.  See
# https://recotem.org/2.1/docs/serving-api.html#feature-aware-cold-start
#
...
def _row_values(state: dict, values: dict) -> tuple[list[int], list[float], list[str]]:
    ...
    for spec in state["columns"]:
        ...
        if spec["encoding"] == "categorical":
            ...
            # occurrence. https://recotem.org/2.1/docs/recipe-reference.html documents this encoding as
