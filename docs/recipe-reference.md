...
Blacklisted (never expanded regardless of prefix): `RECOTEM_SIGNING_KEY`, `RECOTEM_API_KEYS`, and any name matching `*_SECRET*`, `*_PASSWORD*`, `*_TOKEN*`, `*_KEY*`, `AWS_*`, `GOOGLE_*`, `GCP_*`.
