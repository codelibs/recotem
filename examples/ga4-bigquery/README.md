...
[Cloud storage extras](https://recotem.org/2.1/docs/data-sources/csv.html#cloud-storage-extras)).
...
recipe field expansion (see [Recipe reference](https://recotem.org/2.1/docs/recipe-reference.html)).
