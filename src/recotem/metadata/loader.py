...
``https://recotem.org/2.1/docs/security.html`` for the threat model.
...
class MetadataError(ValueError):
    ...
    cause:
        ...
        ``"integrity"``
            ...
            mismatch that ``https://recotem.org/2.1/docs/operations.html`` and ``https://recotem.org/2.1/docs/deployment/kubernetes.html``
    ...
    *,
    ...
    if sha256 is not None:
        ...
        try:
            ...
            # the code ``https://recotem.org/2.1/docs/deployment/kubernetes.html`` marks "Retry", so a CronJob
