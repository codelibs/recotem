...
def test_allowed_hosts_always_admits_the_probe_host(
    ...
    override branch did not, and `https://recotem.org/2.1/docs/deployment/kubernetes.html` tells operators to
...
# https://recotem.org/2.1/docs/deployment/kubernetes.html both describe.
# ---------------------------------------------------------------------------
...
# chart's Service is `recotem` by default (https://recotem.org/2.1/docs/deployment/kubernetes.html installs the
...
# (`reason: size_cap`, /v1/health/ready 503). `https://recotem.org/2.1/docs/deployment/kubernetes.html` tells
